    ...
    return (
        <AuthWrapper>
            ...
            <div className="w-full max-w-md mb-8 text-center">
                ...
                <h1 className="text-4xl text-white mt-3 font-bold text-center mb-2">Login a new account</h1>
                <p className="text-center text-white mb-6 text-[18px]">
                   Don’t have an account?{' '}
                    <Link href="/register" className="text-[#FF9500] hover:text-[#FF9500] font-medium">
                        Sign up
                    </Link>
                </p>
            </div>
